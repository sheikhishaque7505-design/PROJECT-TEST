    ...
    <div className="app-root">
      ...
      {showFiltration && filtrationData.stage && !liveTrafficMode && (
        <div className="filtration-panel">
          <button className="close-x-btn" onClick={() => setShowFiltration(false)}>✕</button>
          ...
          <div className="fp-meter-row">
            ...
            <span
              style={{
                color: filtrationData.purity > 90 ? "#2ecc71" : filtrationData.purity > 50 ? "#ffdd57" : "#ff6b6b",
                fontWeight: 700,
              }}
            >
          ...
          <div className="fp-meter">
            <div
              ...
              style={{
                ...
                background: filtrationData.purity > 90
          ...
          <div className="fp-meter">
            <div
              className="fp-meter-fill"
              style={{ width: `${(filtrationData.progress || 0) * 100}%`, background: "#22cfff" }}
            />
          </div>
            ...
            {filtrationData.allStages?.map((stage, i) => (
              <div
                ...
                className={`fp-stage-item ${
                  i < filtrationData.stageIndex ? "done" : i === filtrationData.stageIndex ? "active" : ""
                }`}
              >
      ...
      {!showFiltration && filtrationData.stage && !liveTrafficMode && (
        <button className="reopen-btn filtration-reopen" onClick={() => setShowFiltration(true)}>
          💧 FILTRATION
        </button>
      )}
      ...
      {showWaste && wasteStage.stage && !liveTrafficMode && (
        <div className="waste-panel">
          <button className="close-x-btn" onClick={() => setShowWaste(false)}>✕</button>
          ...
          <div className="wp-meter">
            <div className="wp-meter-fill" style={{ width: `${(wasteStage.progress || 0) * 100}%` }} />
          </div>
            ...
            {wasteStage.allStages?.map((stage, i) => (
              <div
                ...
                className={`wp-stage-item ${
                  i < wasteStage.stageIndex ? "done" : i === wasteStage.stageIndex ? "active" : ""
                }`}
              >
      ...
      {!showWaste && wasteStage.stage && !liveTrafficMode && (
        <button className="reopen-btn waste-reopen" onClick={() => setShowWaste(true)}>
          ♻️ WASTE
        </button>
      )}
      ...
      {!showTraffic && !liveTrafficMode && (
        <button className="reopen-btn traffic-reopen" onClick={() => setShowTraffic(true)}>🚦 TRAFFIC</button>
      )}
      ...
      <div className={`main-menu ${menuOpen ? "open" : ""}`}>
        ...
        <div className="menu-list">
          <div className={`menu-item ${showTraffic ? "active" : ""}`} onClick={() => setShowTraffic((v) => !v)}>
            <span className="m-icon">🚦</span>
            <span className="m-label">Traffic Panel</span>
            <span className="arrow">{showTraffic ? "ON" : "OFF"}</span>
          </div>
          <div className={`menu-item ${showFiltration ? "active" : ""}`} onClick={() => setShowFiltration((v) => !v)}>
            <span className="m-icon">💧</span>
            <span className="m-label">Filtration Panel</span>
            <span className="arrow">{showFiltration ? "ON" : "OFF"}</span>
          </div>
          <div className={`menu-item ${showWaste ? "active" : ""}`} onClick={() => setShowWaste((v) => !v)}>
